...
public class GlobalExceptionHandler {
        ...
        @ExceptionHandler(BadStateTransitionException.class)
        public ResponseEntity<ErrorResponse> handleBadStateTransition(
                        BadStateTransitionException ex,
                        HttpServletRequest request) {
                log.error("Transición de estado inválida: {} - {} -> {}",
                                ex.getEntidad(), ex.getEstadoActual(), ex.getEstadoIntentado());

                // Crear mapa con detalles adicionales de la transición
                Map<String, String> detalles = new HashMap<>();
                detalles.put("entidad", ex.getEntidad());
                detalles.put("estadoActual", ex.getEstadoActual());
                detalles.put("estadoIntentado", ex.getEstadoIntentado());
                detalles.put("transicionesPermitidas", ex.getTransicionesPermitidas().toString());
